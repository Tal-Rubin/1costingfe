...
The table below is for a D-T plant. The thermal cycle is the only conversion pathway considered here (direct energy conversion is analyzed separately in the [follow-on dispatch](https://1cf.energy/direct-energy-conversion/)). When the same configuration is run for aneutronic fuels, the BOP equipment subtotal is essentially unchanged (roughly $386M), because turbine, heat-rejection, and electrical hardware all scale with thermal-electric power rather than fuel choice. The fuel-related cost differences show up in buildings and staffing (covered later), not in BOP equipment:

| Component | Cost | What it is |
| --- | --- | --- |
| Turbine & generator | $181M | sCO2 turbomachinery, comparable to gas plant hardware |
...
| --- | --- | --- | --- |
| Baseline: 1 GWe, 85%, 7% WACC, 30yr, 6yr build | 29 | 1,723 | -$19/MWh |
| 2 GWe, 85%, 7%, 30yr, 6yr | 24 | 1,505 | -$14/MWh |
| 2 GWe, 95%, 3%, 50yr, 3yr | 14 | 1,213 | -$3.6/MWh |
| 3 GWe, 95%, 3%, 50yr, 3yr | 12 | 1,153 | -$1.9/MWh |
| 5 GWe, 95%, 2%, 50yr, 3yr | 9.5 | 1,094 | +$0.5/MWh |

Even at the most aggressive conditions (a 5 GWe plant with 95% availability, 2% WACC, 50-year life, and 3-year construction), the D-T floor barely crosses $10/MWh, leaving only $0.5/MWh of budget for the fusion core. That translates to roughly $40/kW of overnight capital for the entire core: magnets, heating, vacuum vessel, structure, power supplies, and installation. For reference, a single large superconducting magnet costs more than this. The D-T floor cannot be pushed low enough to make room for the core.

The reason is the buildings and staffing. D-T buildings cost $574M at 1 GWe because neutrons and tritium demand shielding, hot cells, containment barriers, and nuclear-rated HVAC. D-T staffing runs to 78 FTE because those hazards require health physics technicians, tritium processing personnel, radwaste handlers, and hot cell operators. These costs scale down with plant size but never disappear. They are structural consequences of the fuel choice, not of the plant design.

## Reducing D-T Staffing

At the most aggressive conditions in the table above (5 GWe, 2% WACC), the D-T floor is $9.5/MWh. O&M staffing accounts for roughly half of that. D-T staffing is high (78 FTE at 1 GWe) because of the radiation and tritium hazards: health physics technicians (10-15), tritium processing and accountability personnel (10-20), radioactive waste handling (5-10), and hot cell operators for remote maintenance of activated components. Can automation close the remaining gap?
...
How much does staffing need to fall to cross the $10/MWh threshold? At the aggressive 5 GWe conditions, the D-T floor is $9.5/MWh, of which $5.2/MWh is O&M. The capital-only floor is $4.3/MWh, well below the target. D-T reaches $10/MWh at this scale with current staffing levels. At 2 GWe (a more realistic near-term scale), the capital floor is $5.8/MWh, and staffing needs to fall to about 54% of current levels (roughly 42 FTE instead of 78) to reach $10/MWh.

| Scenario (D-T, free core) | Floor | Capital only | Staffing threshold for $10/MWh |
| --- | --- | --- | --- |
| 2 GWe, 95%, 3%, 50yr, 3yr | $13.6/MWh | $5.8/MWh | 54% of current (42 FTE) |
| 5 GWe, 95%, 2%, 50yr, 3yr | $9.5/MWh | $4.3/MWh | 108% of current (no cuts needed) |
...
| --- | --- | --- | --- |
| Baseline: 1 GWe, 85%, 7% WACC, 30yr, 6yr build | 17 | 1,221 | -$7.3/MWh |
| 2 GWe, 85%, 7%, 30yr, 6yr | 14 | 1,058 | -$4.4/MWh |
| 2 GWe, 95%, 3%, 50yr, 3yr | 7.1 | 846 | +$2.9/MWh |
| 3 GWe, 95%, 3%, 50yr, 3yr | 6.3 | 802 | +$3.7/MWh |
| 5 GWe, 95%, 2%, 50yr, 3yr | 5.0 | 759 | +$5.0/MWh |
...
Radical staffing reduction also reduces the building costs. A 15-FTE plant still needs a control room, canteen, locker rooms, parking. A near-zero-FTE plant looks more like a data center: remote monitoring, automated systems, minimal human-occupied space. That could strip $50-100M from the $359M building cost, flowing directly into overnight capital and LCOE. Together, near-zero staffing and the associated building scope reduction would drop the floor from $7.1/MWh to roughly $4.2/MWh, leaving $5.8/MWh of budget for the fusion core. At the limit, automation does not just reduce O&M; it removes building scope.
