...
\href{https://www.osti.gov/biblio/7341986}{demonstrated at 48\%
efficiency} on real mirror plasma at LLNL's TMX (1982), with a
...
The venetian blind hardware, consisting of grids, power conditioning,
incremental vacuum and tank volume, costs
\href{https://www.osti.gov/biblio/7218298}{\$79--128M} at 400 MWe DEC
electric output, comparable to the turbine island it partially replaces
(\$168M for sCO2 at 1 GWe).
...
60\% (never demonstrated on real plasma), the hybrid floor stays at
\$18/MWh. Eliminating the turbine entirely and wasting the
...
inverter at the back. A utility-scale solar inverter (\$30-50/kW,
\href{https://www.nrel.gov/solar/market-research-analysis.html}{NREL})
...
For the venetian blind, the core cost is effectively flat: the added DEC
hardware (counted as part of the core in standard fusion accounting)
offsets the savings from smaller heating and blanket systems. For pulsed
inductive, the core jumps \$407M because the pulsed-power chain that
replaces the turbine (dominated by the recovery cap bank) is
substantial. LCOE drops \$10/MWh with the venetian blind and \$24/MWh
with pulsed inductive, but the pulsed savings come entirely from fuel,
not hardware: higher efficiency means less fusion power per MWh, which
means less He-3 burned. For D-He3, DEC is primarily a fuel-saving
technology.

For p-B11 (negligible fuel cost), the effect is smaller: thermal LCOE is
\$37/MWh, VB DEC 60\% is \$37/MWh (core \$1,189M vs \$1,209M). Because
...
\item
  Barr, W.L. et al., ``Experimental Results from a Beam Direct Converter
  at 100 kV,'' \emph{Journal of Fusion Energy} 2, 131-143 (1982).
  \href{https://www.osti.gov/biblio/7341986}{Link}
\item
...
\item
  NREL, ``U.S. Solar Photovoltaic System and Energy Storage Cost
  Benchmarks.''
  \href{https://www.nrel.gov/solar/market-research-analysis.html}{Link}
\item
