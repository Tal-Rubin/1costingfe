...
\texttt{interest\_rate} ($+0.38$). The \texttt{fuel\_recovery} entry
...
carries an elasticity of $+0.38$ and \texttt{inflation\_rate} $+0.17$.
...
\midrule
\texttt{fuel\_recovery}  & $-7.192796$ & $-7.192848$ & $7.10{\times}10^{-6}$ \\
\texttt{availability}    & $-0.539476$ & $-0.539393$ & $1.54{\times}10^{-4}$ \\
\texttt{u\_he3}          & $+0.454599$ & $+0.454637$ & $8.45{\times}10^{-5}$ \\
\texttt{eta\_de}         & $-0.398529$ & $-0.398611$ & $2.06{\times}10^{-4}$ \\
\texttt{interest\_rate}  & $+0.384562$ & $+0.385012$ & $1.17{\times}10^{-3}$ \\
\bottomrule
\end{tabular}
\end{table}
